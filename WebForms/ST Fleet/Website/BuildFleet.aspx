<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="BuildFleet.aspx.cs" Inherits="BuildFleet" %>
    ...
    <div class="row">
        <div class="col-md-6">
            <fieldset>
                ...
                <asp:TextBox ID="Registry" runat="server" />
